                        ...
                        >
                            ...
                            <div className="p-4 space-y-4 text-gray-600 font-heebo">
                                ...
                                <p className="font-heebo text-md">
                                    At <span className="font-bold">Affclickzen</span>, your privacy is very important to us. We are headquartered in USA. We are dedicated to providing you with superior service while protecting your privacy and safeguarding your personal information.
                                ...
                                <div>
                                    <h1 className="font-semibold text-md">Affclickzen</h1>
                                    <p className="font-heebo text-md">1900 Olevia St, Jacksonville, FL 32207</p>
                                    <p className="font-heebo text-md">privacy@Affclickzen.com</p>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                        ...
                        >
                            ...
                            <div className="p-4 space-y-4 text-gray-600 font-heebo">
                                ...
                                <p className="font-heebo text-md">
                                    THIS AFFILIATE AGREEMENT (the "Agreement"), together with any amendments, are entered into by and between mrge BC Advertising Inc. dba Affclickzen ("Affclickzen"), and the applying Party submitting the Application For Affiliate Status (the "Affiliate"), also referred to herein jointly as the Parties ("Parties", each a "Party"). This Affiliate Agreement supplements all other Campaign Terms subsequently agreed to by the Affiliate.
                                </p>
                                <p className="font-heebo text-md ">

                                    WHEREAS, Affclickzen and Affiliate desire to provide for the terms and conditions of this Affiliate Agreement as more specifically set forth herein;
                                </p>
                                ...
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    ...
                                    <li><strong>1.3. "Action":</strong> Means a User's completion of an action (such as a click, sale, lead, or call) defined by the Advertiser or Affclickzen.</li>
                                    <li><strong>1.4. "Network":</strong> Means the advertising Network operated by Affclickzen, which is made up of Affiliates and Advertisers.</li>
                                    <li><strong>1.5. "Advertiser":</strong> Means the advertiser, Advertiser, or advertising agency providing advertisements to Affclickzen for use by the Affiliate.</li>
                                    <li><strong>1.6. "Ad":</strong> Means the advertisement in the form of graphics and/or text supplied to Affclickzen for inclusion in the Affclickzen Network and to be made available for Affiliate use.</li>
                                    <li><strong>1.7. "Spam":</strong> Means unsolicited bulk email where recipients have not agreed in advance to receive Ads.</li>
                                    <li><strong>1.8. "Campaign Terms":</strong> Means the specific guidelines for each Advertiser campaign as listed in the Affclickzen Network.</li>
                                ...
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>2.1.</strong> From time to time, Affclickzen may amend, replace or supplement the Agreement, including but not limited to changing Advertiser payouts, by posting an updated Agreement or Campaign Terms on the Affclickzen website, and it shall be deemed effective immediately unless otherwise noted, and Affiliate will be deemed to have consented to, and agreed to be bound by, the updated Agreement or Campaign Terms. It is the responsibility of the Affiliate to read and keep up to date with the Agreement and Campaign Terms with or without notice of change from Affclickzen.
                                    </li>
                                </ul>
                                <p className="font-semibold text-md font-heebo">3. Affiliate Requirements.</p>
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>3.1.</strong> Affiliate is subject to review and may be rejected for any reason, and at any time, by Affclickzen.
                                    </li>
                                    <li><strong>3.2.</strong> Affiliate must submit valid and correct contact information, including but not limited to name, e-mail address, street address, and telephone number. Affiliate must ensure this information remains up-to-date at all times within the Affclickzen Network. Affiliate must accurately, clearly and completely describe all promotional methods in their descriptions and provide additional information when necessary.
                                    </li>
                                    ...
                                    <li><strong>3.5.</strong> In its sole discretion, if at any time Affclickzen deems the Affiliate's website or advertising activities are contrary to the terms set out in the Agreement, the Affiliate shall be terminated from the Network and shall forfeit any and all commissions and earnings.
                                ...
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>4.1.</strong> Failure to adhere to the following rules is a violation of the Agreement and will result in immediate termination of the Affiliate from the Affclickzen Network with forfeiture of all monies due to Affiliate.
                                    </li>
                                    <li><strong>4.2.</strong>Affiliate must not load Advertiser's website within a frameset or iframe unless prior written approval is obtained from Affclickzen.
                                    </li>
                                    <li><strong>4.3.</strong> Affiliate must not modify the Ads supplied by Affclickzen in any way unless prior written approval is obtained from Affclickzen.
                                    </li>
                                    <li><strong>4.4.</strong> Affiliate must indicate whether he uses incentive traffic, and only offer incentives to Users to respond to Ads with permission from Affclickzen and the Advertiser as indicated on the Network and Campaign Terms, or in writing. Affclickzen reserves the right to define the term incentive.
                                    </li>
                                    <li><strong>4.5.</strong> Affiliate must not make misleading or disparaging statements, oral or written, about any Ad, Advertiser or Affclickzen.
                                    </li>
                                    <li><strong>4.6.</strong> Affiliate must agree to receive periodic communications from Affclickzen. This communication could be in the form of e-mail, instant message, postal mail, telephone or fax.
                                    </li>
                                    ...
                                    <li><strong>4.11.</strong> Affiliate must not share, lend, lease, sell or transfer their account to any third Party unless prior written approval is obtained from Affclickzen.
                                    </li>
                                    ...
                                    <li ><strong>4.12.1.</strong> Affiliate must distribute Ads only to those recipients who have Opted-in to receive such email from the Affiliate. Affclickzen prohibits the use of Spam. Any use of Spam whatsoever by Affiliate will result in the forfeiture of Affiliate's entire commission for all campaigns, and the termination of the Affiliate's account. Affiliate will also be held liable for any and all damages resulting from a violation of this provision including reasonable court costs.
                                    </li>
                                    <li ><strong>4.12.2.</strong> If requested by Affclickzen, Affiliate must be able within 24 hours of such request, to supply the name, date, time, IP address and URL where the User gave permission to the Affiliate to receive such Ads through e-mail.
                                    </li>
                                    ...
                                    <li ><strong>4.12.4.</strong> Affiliate must not use the Advertiser or Affclickzen name (including any abbreviation thereof) in the originating email address line ("From" line) or subject line of any email transmission, unless specific permission is given otherwise.
                                    </li>
                                    ...
                                    <li ><strong>4.12.13.</strong> Affiliate must comply with all campaign instructions from Affclickzen and Advertiser as set out in Campaign Terms.
                                    ...
                                    <li ><strong>4.13.</strong> If Affiliate has not logged into their account for six (6) consecutive months, it will be moved to an inactive status. If this inactivity continues for nine (9) months, Affclickzen reserves the right to terminate the account for inactivity and debit any remaining balance that is held in the Affiliate account.
                                    </li>
                                    <li ><strong>4.14.</strong> If Affiliate (i) operates from a jurisdiction subject to Applicable Privacy Laws; (ii) markets to or targets individuals in a jurisdiction subject to Applicable Privacy Laws; or (iii) collects or otherwise processes any personal information from users in a jurisdiction subject to Applicable Privacy Laws, then Affiliate hereby represents, warrants, covenants and agrees that Affiliate will (a) comply with Applicable Privacy Laws; (b) inform end users in a prominent manner of their rights under Applicable Privacy Laws and that Affiliate uses tracking devices and cookies for advertising purposes, including Interest-Based Advertising; and (c) obtain all required end user consents to place tracking devices, such as cookies (including those enabled by Affclickzen at Affiliate’s request on Affiliate’s behalf) on such end users' computers and internet enabled devices and provide information regarding the removal of such tracking devices.
                                    </li>
                                </ul>


                                <p className=" text-md font-heebo"> <strong>5.</strong>  If Affiliate determines that Applicable Privacy Laws do not apply to them, then Affiliate shall provide Affclickzen with its analysis concluding the same or, provide detailed information regarding the specific steps Affiliate takes to ensure that individuals located in jurisdictions subject to Applicable Privacy Laws do not visit Affiliates’ Site via our services and technology..</p>
                                <p className="font-semibold text-md font-heebo">6.  Advertising Services and Warranties..</p>
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>6.1.</strong> Provided that Affiliate complies with all provisions of this Agreement and Campaign Terms, Affclickzen hereby grants to Affiliate a non-exclusive, limited, revocable license to market, display, perform, copy, transmit, and promote the Ad in connection with its obligations hereunder; and market display, perform, copy, transmit, and promote the Ad to third Parties in connection with its obligations hereunder. Affiliate's use of Ads or copyrighted materials in violation of this Agreement is strictly forbidden and will result in this limited license being immediately withdrawn and may further result in the termination of the Affiliate's account and being held liable under applicable law.

                                    </li>
                                    <li><strong>6.2.</strong> Affclickzen's sole obligation to the Affiliate under this Agreement with respect to Ads shall be to provide such Ads for use in their advertising efforts. The advertising services provided by Affclickzen are provided "as is". Affclickzen makes no warranties, guaranties, promises, or estimates, expressed or implied, oral, written or otherwise except as specifically set forth herein, AND does not guarantee, including but not limited to, demographic profiling of Users, click to Action conversion rates, response rates or conversion rates from Action to sale.
                                ...
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>7.1.</strong> Affclickzen shall send Affiliate's commission payment approximately fifteen (15) days from the last business day of each month in which earnings are accrued if the amount due to Affiliate exceeds either one hundred (100) dollars USD or the minimum payment amount requested by the Affiliate, whichever is higher. Payment thresholds may vary based payment type chosen by Affiliate. Policies regarding payment type thresholds can change without notice to Affiliate. Commissions will only be earned on Actions reported by the Advertiser, and only after Affclickzen receives full payment from the Advertiser. Affclickzen is under no obligation to pay Affiliates for Actions which are not paid by the Advertiser.
                                    </li>
                                    <li><strong>7.2.</strong> Affclickzen shall increase the payment frequency for Affiliate to weekly, provided Affiliate has received one previous payment from Affclickzen and is setup to receive payments electronically. All other conditions and restrictions for payment as outlined in item 6.1 remain in force for weekly payments. Affclickzen in its sole discretion may disqualify any Affiliate from being eligible for weekly payments.
                                    </li>
                                    <li><strong>7.3.</strong> In the event of non-payment by an Advertiser, and If Affclickzen elects in its own discretion not to make payment to Affiliate, an Affiliate's recourse for any earned commissions not paid shall be to make a claim against the relevant Advertiser(s), and Affclickzen disclaims any and all liability for such payment.
                                    </li>
                                    <li><strong>7.4.</strong> Affclickzen or the Advertiser may reverse any Action generated by the Affiliate. Circumstances for Action reversals include but are not limited to duplicate Actions, fraudulently generated Actions, non-payment, Affiliate's failure to comply with the Agreement, invalid or incomplete data, or product returns. Reversals may be applied at any time, including for Actions during a period where payment has already been issued to the Affiliate.
                                    </li>
                                    <li><strong>7.5.</strong> In the event reversals are applied to Actions for which an Affiliate has already been paid, Affiliate is required to return payment for these Actions to Affclickzen.
                                    </li>
                                </ul>

                                <p className="font-semibold text-md font-heebo">8. Referral Program.</p>
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>8.1.</strong> Affiliate shall earn a 10% referral fee on the commission payments made to any other new Affiliates (excluding bonuses, rewards, additional payouts, Affiliate earnings where the Affiliate is an advertising Network, and referral income) who have been referred to Affclickzen using the specified link code. Affiliate shall earn this fee on the commission payments of a referred Affiliate for a period of six (6) months after the referred Affiliate joins the Affclickzen Network. Secondary accounts held by Affiliate are excluded from the referral program. Affclickzen reserves the right to terminate an Affiliate referral program, in whole or in part, at any time for any reason, including but not limited to, fraud, questionable activity or breach of the terms set out in the Agreement or Campaign Terms.
                                    </li>
                                </ul>
                                ...
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>10.1.</strong> Affiliate shall not solicit or recruit, directly or indirectly, any Advertiser that is known to Affiliate to be an Advertiser of Affclickzen, for purposes of offering products or services that are competitive with Affclickzen, nor contact such Advertisers for any purpose, during the term of Affiliate's membership in the Affclickzen Network and for the twelve (12) month period following termination of Affiliate's membership in the Affclickzen Network.
                                    </li>
                                </ul>
                                <p className="font-semibold text-md font-heebo">11. Limitation of Liability. </p>
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>11.1.</strong> EXCEPT FOR THE INDEMNIFICATION PROVISIONS AT CLAUSE 12, UNDER NO CIRCUMSTANCES SHALL EITHER PARTY BE LIABLE TO THE OTHER FOR INDIRECT, INCIDENTAL, PUNITIVE, CONSEQUENTIAL, SPECIAL OR EXEMPLARY DAMAGES OR COSTS, DIRECT OR INDIRECT, (EVEN IF SUCH PARTY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES), ARISING FROM AFFILIATE PARTICIPATION IN Affclickzen'S NETWORK. Affclickzen SHALL NOT IN ANY EVENT BE LIABLE TO AFFILIATE FOR MORE THAN THE AMOUNT PAID TO AFFILIATE HEREUNDER. NO ACTION, SUIT OR PROCEEDING SHALL BE BROUGHT AGAINST Affclickzen MORE THAN ONE YEAR AFTER THE DATE OF SERVICE.
                                    </li>
                                    <li><strong>11.2.</strong> Affiliate agrees not to hold Affclickzen or Advertisers liable for any of the consequences of interruption or service.
                                    </li>
                                </ul>
                                <p className="font-semibold text-md font-heebo">12. Indemnification. </p>
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>12.1.</strong> Affiliate hereto agrees to indemnify and hold harmless Affclickzen, Advertiser, and each if its agents, officers, directors and employees against all liability to third Parties resulting from the acts or failure to act of such indemnifying Party, or any act of its customers or users. Affiliate is solely responsible for any legal liability arising out of or relating to the Affiliate's website(s), any material to which Users can link through the Affiliate's website(s) and/or any consumer and/or governmental/regulatory complaint arising out of any privacy breach, regulatory compliance issue, e-mail campaign or other advertising campaign conducted by Affiliate, including but not limited to any Spam or fraud complaint and/or any complaint relating to failure to have proper permission to conduct such campaign to the consumer.
                                    </li>
                                </ul>
                                <p className="font-semibold text-md font-heebo">13. Confidentiality. </p>
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>13.1.</strong> Affiliate agrees to refrain from disclosing Affclickzen's confidential information or the Advertiser's confidential information (including but not limited to commission rates, conversion rates, email addresses, fees, identities of Advertisers) to any third-Party without prior written permission from Affclickzen.
                                    </li>
                                </ul>
                                ...
                                <ul className=" pl-5 flex flex-col gap-2 font-heebo">
                                    <li><strong>16.1.</strong> Affclickzen reserves the right to withhold payment and take appropriate legal action to cover its damages against any Affiliate that violates the terms of this Agreement or breaches the representations and warranties set forth in this Agreement, or commits fraudulent activity against Affclickzen. Except as otherwise specified, the rights and remedies granted to a Party under the Agreement are cumulative and in addition to, not in lieu of, any other rights and remedies which the Party may possess at law or in equity.
                                    </li>
                                </ul>
                                ...
                                <p>IN WITNESS WHEREOF, the Parties have caused this Agreement to be duly executed and binding upon Affiliate's submission and Affclickzen's acceptance of Affiliate's properly completed Affiliate Network application without need for further action by Affclickzen.</p>
                            </div>
                        </motion.div>
                    </div>
                )}
